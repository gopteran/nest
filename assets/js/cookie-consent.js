...
class GopteranCookieConsent {
    ...
    buildTranslations(ui) {
        ...
        return {
            consentModal: {
                ...
                description: consentModal.description || 'This website uses cookies to ensure you get the best experience.',
    ...
    async loadLibrary() {
        return new Promise((resolve, reject) => {
            ...
            script.src = this.config.library?.cdn_url || 'https://cdn.jsdelivr.net/gh/orestbida/cookieconsent@v3.0.1/dist/cookieconsent.umd.js';
            script.async = true;
